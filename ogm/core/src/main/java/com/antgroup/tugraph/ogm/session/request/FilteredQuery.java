...
import com.antgroup.tugraph.ogm.session.request.strategy.AggregateStatements;
import com.antgroup.tugraph.ogm.session.request.strategy.DeleteStatements;
import com.antgroup.tugraph.ogm.session.request.strategy.QueryStatements;
 ...
 * The various implementing classes of {@link DeleteStatements},
 * {@link AggregateStatements} and
 * {@link QueryStatements} can set the return clause that
 * fits their purpose.
 *
 * @author vince
 */
